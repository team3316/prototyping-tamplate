...
public class PS5Controller extends GenericHID {
    ...
    /**
     * Whether the mute was pressed since the last check.
     *
     * @return Whether the mute was pressed since the last check.
     */
    ...
    /**
     * Whether the mute was released since the last check.
     *
     * @return Whether the mute was released since the last check.
     */
     ...
     *
     * @param loop the event loop instance to attach the event to.
     * @return an event instance representing the mute's digital signal attached to
     *         the given loop.
     */
    public BooleanEvent mute(EventLoop loop) {
        return new BooleanEvent(loop, this::getMute);
    }
}
